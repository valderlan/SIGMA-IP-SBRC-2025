...
class FeatureNormalizer:
    def __init__(self, config_path="/home/davioliveira/projects/SIGMA-IP-SBRC-2025/api/netcontrol/ia_model/config.json"):
    ...
    def carregar_pesos_salvos(self, pasta="/home/davioliveira/projects/SIGMA-IP-SBRC-2025/api/netcontrol/ia_model/weights", nome_arquivo="/home/davioliveira/projects/SIGMA-IP-SBRC-2025/api/netcontrol/ia_model//weights/final_weights.json"):
    ...
    def aplicar_pesos_em_novo_dataset(self, dataset_path=None, output_path=None):
        ...
        # 1. Categorização da coluna risk_recommended_pulsedrive (primeira etapa)
        ...
        if "ip" in df.columns:
            df_norm_to_save.insert(0, "ip", df["ip"])
